...
const WhyUs = () => {
  ...
  const FlipCard = ({
    ...
    return (
      <div className="w-full flex h-40 px-1 py-4 gap-6.5 items-center">
  ...
  return (
    <section className="px-14 mt-20 py-3 flex gap-2">
      <div className="w-1/3 ">
        <p className="font-inter text-gray-700 font-medium text-[13px]">
          <span className="text-primary">/</span>Why us?
        </p>
        <h1 className="text-5xl mt-2.5 font-poppins">
          The Jeraven
          <span className="bg-primary-shade flex w-fit gap-x-3 text-white px-1 py-1">
            Difference
          </span>
        </h1>
        ...
        <button className="mt-5 flex items-center text-primary font-inter text-[13px]">
          Try Jeraven Today <ChevronRight className="w-4 h-4" />
        </button>
      </div>

      <div className="w-2/3 flex min-h-96">
        <div className="w-1/2 self-end px-7">
          <FlipCard
        ...
        <div className="h-full w-[1px] bg-gradient-to-t from-lighter-primary to-transparent"></div>

        <div className="w-1/2 self-start px-7">
          <FlipCard
